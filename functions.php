...
function wphierarchy_widgets_init() {
	...
	register_sidebar( [
		'name'			=> esc_html__( 'Search Sidebar', 'wphierarchy' ),
		'id'			=> 'search-sidebar',
		'description'	=> esc_html__( 'Add widgets for search sidebar here', 'wphierarchy' ),
		'before_widget'	=> '<section class="search-widget">',
		'after_widget'	=> '</section>',
